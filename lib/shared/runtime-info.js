 ...
 * @returns A string that contains execution environment information.
 */
function environment() {
	 ...
	 * @returns Whether or not the given path is a child of a directory.
	 */
	 ...
	 * @param args The arguments to be executed with the command.
	 * @throws As may be collected by `cross-spawn.sync`.
	 * @returns The version returned by the command.
	 */
	 ...
	 * @param versionStr The string to normalize.
	 ...
	 * @throws As may be collected by `cross-spawn.sync`.
	 * @returns The normalized version returned by the command.
	 */
	 ...
	 * @param global Whether to check globally or not.
	 * @throws As may be collected by `cross-spawn.sync`.
	 * @returns The normalized version returned by the command.
	 */
 ...
 * @returns The version from the currently executing ESLint's package.json.
 */
function version() {
