...
/**
 * Why a flag is no longer active.
 *
 * The three states are distinguished by `replacedBy`, not by a discriminant
 * tag, which is why the property is optional *and* nullable:
 *
 * - a string: the flag was renamed to that flag on stabilization;
 * - `null`: the feature shipped and is now on by default;
 * - absent: the feature was abandoned.
 * @typedef {Object} InactiveFlagData
 * @property {string} description What the flag used to do.
 * @property {string | null} [replacedBy] The flag that supersedes this one.
 */
