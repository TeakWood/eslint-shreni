...
/**
 * Describes a flag that used to be active.
 * @typedef {Object} InactiveFlagData
 * @property {string} description The reason the flag is no longer active.
 * @property {string | null} [replacedBy] The name of the flag that replaced this
 * one, or `null` when the feature is now enabled by default. Absent when the
