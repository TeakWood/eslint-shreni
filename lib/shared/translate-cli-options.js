 ...
 * @param importer An object with an `import` method called once for each plugin.
 * @param pluginNames The names of the plugins to be loaded, with or without the "eslint-plugin-" prefix.
 * @returns A mapping of plugin short names to implementations.
 */
 ...
 * @param message The lint result.
 * @returns `true` if the lint message is an error (and thus should be
 ...
 * @param rule The rule id and severity.
 * @returns `true` if the lint rule should run, `false` otherwise.
 */
 ...
 * @param cliOptions The CLI options to translate.
 * @returns The options object for the ESLint constructor.
 */
