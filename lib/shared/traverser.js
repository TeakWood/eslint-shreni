...
class Traverser {
	 ...
	 * @param [options.visitorKeys=DEFAULT_VISITOR_KEYS] The keys of each node types to traverse child nodes. Default is `./default-visitor-keys.json`.
	 * @param [options.enter=noop] The callback function which is called on entering each node.
	 * @param [options.leave=noop] The callback function which is called on leaving each node.
	 */
