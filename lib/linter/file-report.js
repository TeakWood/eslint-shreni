 ...
 * @param location.line The starting line number.
 * @param location.column The starting column number.
 * @param [location.endLine] The ending line number.
 * @param [location.endColumn] The ending column number.
 ...
 * @param ruleId the ruleId to create
 ...
 * @param options to create linting error
 * @param severity the error message to report
 * @param language the language to use to adjust the location information.
 * @returns created problem, returns a missing-rule problem if only provided ruleId.
 * @private
 */
 ...
 * @returns A normalized object containing report information
 */
 ...
 * @param descriptor A descriptor to validate
 ...
 * @param descriptor A descriptor for the report from a rule.
 * @returns An updated location that infers the `start` and `end` properties
 ...
 * @param fix The fix to clone.
 * @returns Deep cloned fix object or `null` if `null` or `undefined` was passed in.
 */
 ...
 * @param fixes The fixes to merge.
 * @param sourceCode The source code object to get the text between fixes.
 * @returns The merged fixes
 */
 ...
 * @param sourceCode The source code object to get text between fixes.
 * @returns The fix for the descriptor
 */
 ...
 * @param descriptor The report descriptor.
 * @param sourceCode The source code object to get text between fixes.
 * @param messages Object of meta messages for the rule.
 * @returns The suggestions for the descriptor
 */
 ...
 * @param options Information about the problem
 * @param options.ruleId Rule ID
 * @param options.severity Rule severity
 * @param options.message Error message
 * @param [options.messageId] The error message ID.
 * @param options.loc Start and end location
 * @param options.fix The fix object
 * @param options.suggestions The array of suggestions objects
 * @param [options.language] The language to use to adjust line and column offsets.
 ...
 * @param suggest The incoming suggest data.
 * @param messages Object of meta messages for the rule.
 */
 ...
 * @throws If messageId is not found or both message and messageId are provided.
 */
...
class FileReport {
	 ...
	 * @param options The options for the file report
	 * @param options.ruleMapper A rule mapper that maps rule IDs to their metadata.
	 * @param options.sourceCode The source code object for the file.
	 * @param options.language The language to use to adjust line and column offsets.
	 * @param [options.disableFixes=false] Whether to disable fixes for this report.
	 */
	 ...
	 * @throws If the messageId is not found or both message and messageId are provided.
	 * @throws If the node is not an object or neither a node nor a loc is provided.
	 */
