 ...
 * @param a The first selector to compare.
 * @param b The second selector to compare.
 * @returns A negative number if `a` is less specific than `b` or they are equally specific and `a` <= `b` alphabetically, a positive number if `a` is more specific than `b`.
 */
...
class ESQueryHelper {
	 ...
	 * @param visitor The visitor containing the functions to call.
	 * @param esqueryOptions `esquery` options for traversing custom nodes.
	 */
	 ...
	 * @param ancestry The ancestry of the node being checked.
	 * @param selector An AST selector descriptor
	 * @returns `true` if the selector matches the node, `false` otherwise
	 */
	 ...
	 * @returns An array of selectors that match the node.
	 */
...
class SourceCodeTraverser {
	...
	/**
	 * Creates a new instance.
	 * @param language The language of the source code being traversed.
	 */
	 ...
	 * @param sourceCode The source code to traverse.
	 * @param visitor The emitter to use for events.
	 * @param options Options for traversal.
	 * @param options.steps The steps to take during traversal.
	 * @throws If an error occurs during traversal.
	 */
