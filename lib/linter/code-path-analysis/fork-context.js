 ...
 * `b`, `d`, and `f`.
 * @param context An instance from which the previous segments
 *      will be obtained.
 * @param startIndex The index of the first segment in the context
 *      that should be specified as previous segments for the newly created segments.
 * @param endIndex The index of the last segment in the context
 *      that should be specified as previous segments for the newly created segments.
 * @param create A function that creates new `CodePathSegment`
 *      instances in a particular way. See the `CodePathSegment.new*` methods.
 * @returns An array of the newly-created segments.
 */
 ...
 * @param context The fork context to work on.
...
class ForkContext {
	 ...
	 * @param idGenerator An identifier generator for segments.
	 * @param upper The preceding fork context.
	 * @param count The number of parallel segments in each element
	 *      of `segmentsList`.
	 */
	 ...
	 * @param replacementHeadSegments The new head segments.
	 */
	 ...
	 * @param otherForkContext The fork context to add from.
	 */
	 ...
	 * @param parentContext The parent fork context.
	 * @param shouldForkLeavingPath Indicates that we are inside of
