 ...
 * @param node A `SwitchCase` node to check.
 * @returns `true` if the node is a `case` node (not `default` node).
 */
 ...
 * @returns `true` if the node is a PropertyDefinition value,
 *      false if not.
 */
 ...
 * path analysis.
 * @param operator The operator found in the LogicalExpression node
 * @returns `true` if the operator is "&&" or "||" or "??"
 */
 ...
 * @param operator The operator found in the AssignmentExpression node
 * @returns `true` if the operator is "&&=" or "||=" or "??="
 */
 ...
 * @returns `true` if the node is a test of a choice statement.
 */
 ...
 * @param node A node to get.
 * @returns a boolean value if the node is a Literal node,
 *   otherwise `undefined`.
 */
 ...
 * @returns `true` if the node is a reference.
 */
...
function processCodePathToEnter(analyzer, node) {
	 ...
	 * @param origin The reason the code path was started.
	 */
...
class CodePathAnalyzer {
	/**
	 * @param eventGenerator An event generator to wrap.
	 */
	 ...
	 * @param node A node which is entering.
	 */
	enterNode(node) {
	 ...
	 * @param node A node which is leaving.
	 */
	leaveNode(node) {
		this.currentNode = node;
	 ...
	 * @param fromSegment A segment of prev.
	 * @param toSegment A segment of next.
	 */
