...
class CodePath {
	 ...
	 * @param options Options for the function (see below).
	 * @param options.id An identifier.
	 * @param options.origin The type of code path origin.
	 * @param options.upper The code path of the upper function scope.
	 * @param options.onLooped A callback function to notify looping.
	 */
	 ...
	 * @param codePath A code path to get.
	 * @returns The state of the code path.
	 */
	 ...
	 * @param [optionsOrCallback] Optional first and last segments to traverse.
	 * @param [optionsOrCallback.first] The first segment to traverse.
	 * @param [optionsOrCallback.last] The last segment to traverse.
	...
	traverseSegments(optionsOrCallback, callback) {
		 ...
		 * @param prevSegment A previous segment to check.
		 * @returns `true` if the segment has been visited.
		 */
		 ...
		 * @param prevSegment A previous segment to check.
		 * @returns `true` if the segment has been skipped.
		 */
