 ...
 * @param segment A segment to get.
...
module.exports = {
	 ...
	 * The DOT code can be visualized with Graphvis.
	 * @param codePath A code path to make DOT.
	 * @param traceMap Optional. A map to check whether or not segments had been done.
	 * @returns A DOT code of the code path.
	 */
