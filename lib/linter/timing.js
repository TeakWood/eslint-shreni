 ...
 * @returns the number of rules to show
 */
 ...
 * @returns prints modified string with console.log
 * @private
 */
...
module.exports = (function () {
	 ...
	 * @param stats if 'stats' is true, return the result and the time difference
	 ...
	 * @returns mapping of ruleId to total time in ms
	 */
	function getData() {
		return { ...data };
	}
	 ...
	 * @param dataToMerge mapping of ruleId to total time in ms
	 */
