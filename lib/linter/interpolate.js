 ...
 * @param {Record<string, string> | undefined} data Map of placeholder name to its value
...
function interpolate(text, data) {
	...
	return text.replace(
		 ...
		 * @param {string} fullMatch The whole `{{ placeholder }}` marker.
		 * @param {string} termWithWhitespace The placeholder name, possibly padded.
