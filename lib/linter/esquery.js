...
class ESQueryParsedSelector {
	 ...
	 * @param source The raw selector string that was parsed
	 * @param isExit Whether this selector is an exit selector
	 * @param root An object (from esquery) describing the matching behavior of the selector
	 * @param nodeTypes The node types that could possibly trigger this selector, or `null` if all node types could trigger it
	 * @param attributeCount The number of class, pseudo-class, and attribute queries in this selector
	 * @param identifierCount The number of identifier queries in this selector
	 */
	constructor(
		source,
		isExit,
	 ...
	 * @param otherSelector The selector to compare against
 ...
 * @returns Object containing selector data.
 */
 ...
 * @returns An object describing the selector if it is simple, or `null` if it is not.
 */
 ...
 * @param source A raw AST selector
 ...
 * @param node The node to check against the selector.
 * @param root The root of the selector to match against.
 * @param ancestry The ancestry of the node being checked, which is an array of nodes from the current node to the root.
