 ...
 * @param directives Unused directives to be removed.
 * @returns Directives grouped by their parent comment.
 */
 ...
 * @param directives Unused directives to be removed.
 * @param parentDirective Data about the backing directive.
 * @param sourceCode The source code object for the file being linted.
 * @returns Details for later creation of output Problems.
 */
 ...
 * @param directives Unused directives to be removed.
 * @param node The backing Comment token.
 * @param sourceCode The source code object for the file being linted.
 * @returns Details for later creation of an output problem.
 */
 ...
 * @param allDirectives Unused directives to be removed.
 * @param sourceCode The source code object for the file being linted.
 * @returns Details for later creation of output Problems.
 */
 ...
 * @param directives The directives to check.
 * @returns The used eslint-enable comments
 */
 ...
 * disable directives.
 * @param options options for applying directives. This is the same as the options
 * for the exported function, except that `reportUnusedDisableDirectives` is not supported
 * (this function always reports unused disable directives).
 * @returns An object with a list
 ...
 * @param options Information about directives and problems
 * @param options.language The language being linted.
 * @param options.sourceCode The source code object for the file being linted.
 * @param options.directives Directive comments found in the file, with one-based columns.
 * Two directive comments can only have the same location if they also have the same type (e.g. a single eslint-disable
 * comment for two different rules is represented as two directives).
 * @param options.problems
 * A list of problems reported by rules, sorted by increasing location in the file, with one-based columns.
 * @param options.reportUnusedDisableDirectives If `"warn"` or `"error"`, adds additional problems for unused directives
 * @param options.configuredRules The rules configuration.
 * @param options.ruleFilter A predicate function to filter which rules should be executed.
 * @param options.disableFixes If true, it doesn't make `fix` properties.
