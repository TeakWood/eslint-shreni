 ...
 * @param it data for the document.
 ...
 * @param totalErrors Total errors
 * @param totalWarnings Total warnings
 * @returns The formatted string, pluralized where necessary
 */
 ...
 * @param totalErrors Total errors
 * @param totalWarnings Total warnings
 * @returns The color code (0 = green, 1 = yellow, 2 = red)
 */
 ...
 * @param it data for the message.
 * @returns HTML (table row) describing the message.
 */
 ...
 * @param parentIndex Index of the parent HTML row.
 * @param rulesMeta Dictionary containing metadata for each rule executed by the analysis.
 * @returns HTML (table rows) describing the messages.
 */
function renderMessages(messages, parentIndex, rulesMeta) {
	/**
	 * Get HTML (table row) describing a message.
	 * @param message Message.
	 * @returns HTML (table row) describing a message.
	 */
	return messages
		.map(message => {
 ...
 * @param it data for the file.
 * @returns HTML (table row) describing the result for the file.
 */
 ...
 * @param rulesMeta Dictionary containing metadata for each rule executed by the analysis.
 * @returns HTML string describing the results.
 */
