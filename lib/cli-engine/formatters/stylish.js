...
/**
 * The style names `util.styleText()` accepts. Spelling it as the first
 * parameter of `styleText` keeps this file honest about what it may pass
 * without restating the (long) list of colors and modifiers here.
 * @typedef {Parameters<typeof util.styleText>[0]} TextStyle
 */

/**
 * Applies a terminal style to a piece of text.
 * @callback StyleText
 * @param {TextStyle} format The style to apply.
 * @param {string} text The text to style.
 * @returns {string} The styled text, or `text` unchanged when colors are off.
 */
...
/**
 * Formats the results as an aligned, colorized table grouped by file.
 * @param {Array<LintResult>} results The lint results to format.
 * @param {FormatterData} [data] The metadata for the run.
 * @returns {string} The formatted results, or an empty string when there are no problems.
 */
