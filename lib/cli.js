 ...
 * @returns The URL of the options module.
 */
 ...
 * @param filePath The path to a file to check.
 ...
 * @param engine The ESLint instance to use.
 * @param results The results to print.
 * @param format The name of the formatter to use or the path to the formatter.
 * @param outputFile The path for the output file.
 * @param resultsMeta Warning count and max threshold.
 * @returns True if the printing succeeds, false if not.
 * @private
 */
 ...
 * @param concurrency The `--concurrency` flag value to validate.
 * @throws If the `--concurrency` flag value is invalid.
 */
...
const cli = {
	 ...
	 * @param configFile The path to the config file to inspect.
	 ...
	 * @param [text] The text to lint (used for TTY).
