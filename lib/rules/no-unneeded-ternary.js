...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns True if the its a boolean literal
		 * @private
		 */
		 ...
		 * @param node A node representing an expression
		 * @returns A string representing an inverted expression
		 */
		 ...
		 * @returns True if it is determined that the node will always evaluate to a boolean value
		 */
		 ...
		 * @param node The ConditionalExpression to check.
