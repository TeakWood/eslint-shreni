 ...
 * @returns The list of character sequences.
 */
 ...
 * @param initialScope Scope to start finding variables. This function tries to resolve identifier references which are in the given scope.
 ...
 * @param charSource Source text of the character to check.
 * @returns Whether the specified regexpp character is represented as an acceptable escape sequence.
 */
 ...
 * @param char Character to check.
 * @param nodeSource Source text of the string or template literal that produces the character.
 * @param codeUnits List of CodeUnit objects of the literal that produces the character.
 * @returns Whether the specified regexpp character is represented as an acceptable escape sequence.
 */
...
module.exports = {
	...
	create(context) {
		...
		function verify(node, pattern, flags, unicodeFixer) {
			 ...
			 * @param matches Lists of individual characters being reported on.
			 * @returns locs for context.report.
