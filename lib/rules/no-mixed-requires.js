...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns {Array<string>} An array of built-in Node.js modules.
		 */
		 ...
		 * @param {ASTNode | null} initExpression The init node of the VariableDeclarator.
		 ...
		 * @param {Array<ASTNode>} declarations The list of VariableDeclarators.
		...
		return {
			/**
			 * Checks a variable declaration for mixed or ungrouped requires.
