 ...
 * @returns True if the operator is commutative and has a
 *     shorthand form.
 */
 ...
 * shorthand form.
 * @param operator Operator to check.
 * @returns True if the operator is not commutative and has
 *     a shorthand form.
 */
 ...
 * @param node The node on the left side of the expression
 * @returns `true` if the node can be fixed
 */
...
module.exports = {
	...
	create(context) {
		 ...
		 * @param node An AssignmentExpression or BinaryExpression node
		 * @returns The operator token in the node
		 */
