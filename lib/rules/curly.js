...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns True if the node is a one-liner that's on the same line as it's preceding code.
		 * @private
		 */
		 ...
		 * @param node The node to check.
		 * @returns True if the node is a one-liner.
		 * @private
		 */
		 ...
		 * @param closingBracket The } token
		 * @returns `true` if a semicolon needs to be inserted after the last statement in the block.
		 */
		 ...
		 * @param node The node to report if there's a problem.
		 * @param body The body node to check for blocks.
		 * @param name The name to report if there's a problem.
		 * @param opts Options to pass to the report functions
		 * @returns a prepared check object, with "actual", "expected", "check" properties.
		 ...
		 * @param node The first IfStatement node of the chain.
		 * @returns prepared checks for each body of the chain. See `prepareCheck` for more
		 *   information.
		 */
