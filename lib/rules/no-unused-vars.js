...
module.exports = {
	...
	create(context) {
		 ...
		 * @param variableType a simple name for the types of variables that this rule supports
		 * @returns The message data to be used with
		 ...
		 * @param variable eslint-scope variable object.
		 * @returns True if the variable is declared with "using" or "await using"
		 * @private
		 */
		 ...
		 * @param variable eslint-scope variable object.
		 * @returns True if the variable has a sibling rest property, false if not.
		 * @private
		 */
		 ...
		 * @param fixer fixer object
		 * @param unusedVar unused variable to fix
		 * @returns fixer object
		 */
		function handleFixes(fixer, unusedVar) {
			 ...
			 * @param node node of identifier
			 * @param skips number of token to skip
			 * @returns start range of token before the identifier
			 */
			 ...
			 * @param node node of identifier
			 * @param skips number of token to skip
			 * @returns end range of token after the identifier
			 */
			 ...
			 * @param node node of identifier
			 * @returns value of token before the identifier
			 */
			 ...
			 * @param node node of identifier
			 * @returns value of token after the identifier
			 */
			 ...
			 * @param node ArrayPattern node
			 * @returns true if array has single element with other null elements
			 */
			 ...
			 * @param type type of import to check
			 * @returns true if import specifier has import of specified type
			 */
			 ...
			 * @returns true if the token is `}` from a block construct
			 */
			 ...
			 * @param nextToken next token of unused variable
			 * @param prevToken previous token of unused variable
			 * @returns true if declaration is not safe to remove
			 */
			 ...
			 * @param node parent node to identifier
			 * @returns fixer object
			 */
