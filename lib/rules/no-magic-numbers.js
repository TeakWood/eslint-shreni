...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns true if the value is ignored
		 */
		 ...
		 * @param fullNumberNode `Literal` or `UnaryExpression` full number node
		 * @returns true if the number is a default value
		 */
		 ...
		 * @param fullNumberNode `Literal` or `UnaryExpression` full number node
		 * @returns true if the number is the initial value of a class field.
		 */
		 ...
		 * @param fullNumberNode `Literal` or `UnaryExpression` full number node
		 * @returns true if the node is radix
		 */
		 ...
		 * @param fullNumberNode `Literal` or `UnaryExpression` full number node
		 * @returns true if the node is a JSX number
		 */
		 ...
		 * @param fullNumberNode `Literal` or `UnaryExpression` full number node
		 * @param value Value expressed by the fullNumberNode
		 * @returns true if the node is a valid array index
		 */
