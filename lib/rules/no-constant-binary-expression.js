...
module.exports = {
	...
	create(context) {
		...
		return {
			/**
			 * Reports a logical expression whose left operand short-circuits constantly.
			 * @param {ASTNode} node The logical expression to check.
			...
			/**
			 * Reports a binary expression whose result is constant.
			 * @param {ASTNode} node The binary expression to check.
			 * @returns {void} No return value.
			 */
