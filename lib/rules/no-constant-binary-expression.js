 ...
 * @param scope The scope in which the node was found.
 * @param node The AST node being tested.
 * @param nonNullish if `true` then nullish values are not considered constant.
 * @returns Does `node` have constant nullishness?
 */
 ...
 * @returns Is `node` guaranteed to be a boolean?
 */
 ...
 * @param scope The scope in which node was found.
 * @param node The node to test.
 * @returns Will `node` always coerce to the same boolean value?
 */
 ...
 * @param scope The scope in which the node was found.
 * @param node The node to test
 * @returns Will `node` always give the same result when compared to a
 ...
 * @param scope The scope in which the node was found.
 * @param node The node to test
 * @returns Will `node` always be new?
 */
 ...
 * @param scope Scope in which the expression was found.
 * @param a One side of the expression
 * @param b The other side of the expression
 * @param operator The binary expression operator
 * @returns The node which will cause the expression to have a constant result.
 */
