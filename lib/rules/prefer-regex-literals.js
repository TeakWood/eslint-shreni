 ...
 * @param node Node to check.
 * @returns True if the node is a regex literal.
 */
...
module.exports = {
	...
	create(context) {
		 ...
		 * @param node Node to check.
		 * @returns True if the node is String.raw`` with a static template.
		 */
		 ...
		 * @param node Node to check.
		 * @returns True if the node is a static string.
		 */
		 ...
		 * @param node Node to check.
		 * @returns True if all arguments are static strings.
		 */
		 ...
		 * @param node Node to check.
		 * @returns True if the node already contains a regex literal argument.
		 */
		 ...
		 * @param ecmaVersion The ecmaVersion to convert.
		 * @returns The resulting ecmaVersion compatible for regexpp.
		 */
		 ...
		 * @returns The resulting escaped character.
		 */
		 ...
		 * @param flags The regex flags to check.
		 * @returns True if the given regex pattern and flags are valid for the ecma version.
		 */
		 ...
		 * @param flagsA The regex flags.
		 * @param flagsB The regex flags.
		 * @returns True if two regex flags contain same flags.
		 */
		 ...
		 * @param flagsA The regex flags.
		 * @param flagsB The regex flags.
		 * @returns The merged regex flags.
		 */
		 ...
		 * @returns True if a node can be fixed to the given regex pattern and flags.
		 */
		 ...
		 * @param newRegExpValue The new regex expression value.
