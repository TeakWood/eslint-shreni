...
/**
 * The callback `eachSelfAssignment()` invokes for every self-assignment it
 * finds. It is always passed the node on the right-hand side, which is what
 * the rule reports against.
 * @typedef {(node: ASTNode) => void} ReportCallback
 */
 ...
 *
 * Both sides are nullable because the recursion walks array elements, which are
 * `null` for holes such as `[, a] = [, a]`, and because `RestElement#argument`
 * and `Property#value` are reached through untyped properties.
 * @param {ASTNode | null} left A left node to traverse. This is a Pattern or
 *      a Property.
 * @param {ASTNode | null} right A right node to traverse. This is a Pattern or
 *      a Property.
 * @param {boolean} props The flag to check member expressions as well.
 * @param {ReportCallback} report A callback function to report.
 * @returns {void}
 */
...
module.exports = {
	...
	create(context) {
		...
		return {
			/**
			 * Reports the parts of an assignment that assign a value to itself.
