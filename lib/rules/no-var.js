 ...
 * @returns `true` if the variable is a global variable.
 */
 ...
 * @returns a function scope or global scope containing the given
 *      scope.
 */
 ...
 * @returns `true` if the variable is used from a closure.
 */
 ...
 * @param node A VariableDeclaration node to check.
 * @returns `true` if the declaration is assigned as part of loop
 *      iteration.
 */
 ...
 * @param node A VariableDeclaration node to check.
 * @returns `true` if the declaration has an initializer.
 */
 ...
 * @param node A node to get. This is a `VariableDeclaration` or
 *      an `Identifier`.
 * @returns A scope node. This is one of `Program`, `BlockStatement`,
 ...
 * @param variable A variable to check.
 * @returns `true` if the variable is redeclared.
 */
 ...
 * @param scopeNode A scope node to check.
 * @returns The predicate function which checks whether a given
...
function isUsedFromOutsideOf(scopeNode) {
	 ...
	 * @returns `true` if the reference is inside of the specified
	 *      scope.
	 */
 ...
 * @param node The initializer node of VariableDeclarator.
 ...
 * @param variable The variable to check.
 * @returns `true` if the variable has a disallowed name.
 */
 ...
 * @param variable The variable to check.
 * @returns `true` if the variable is referenced before its declaration.
 */
...
module.exports = {
	...
	create(context) {
		 ...
		 * @param declarator The VariableDeclarator node to check.
		 * @returns `true` if one of the variables which are defined by the given declarator node have their references in TDZ.
		 */
		 ...
		 * initializer.
		 * @param node A variable declaration node to check.
		 ...
		 * @param node A variable declaration node to report.
		 */
