...
class TextReader {
	 ...
	 * @param [offset=0] The offset where reading starts, relative to the current position.
	 * @param [length=1] Number of characters to read.
	 * @returns A substring of source characters.
	 */
 ...
 * @param reader The reader should be positioned on the first hexadecimal digit.
 ...
 * @param reader The reader should be positioned after the "u".
 * @returns A code unit.
 */
 ...
 * @param reader The reader should be positioned after the first octal digit.
 * @param maxLength The maximum number of octal digits.
 * @returns A code unit.
 */
 ...
 * @param reader The reader should be positioned on the backslash.
 * @returns A string of zero, one or two code units.
 */
 ...
 * @param reader The reader should be positioned on the backslash.
 * @returns Zero, one or two `CodeUnit` elements.
 */
 ...
 * @returns A list of code units produced by the string literal.
 */
 ...
 * @param source The template token to parse, including the delimiting sequences `` ` ``, `${` and `}`.
 * @returns A list of code units produced by the template token.
 */
