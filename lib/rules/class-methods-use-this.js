...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns True if its an instance method
		 * @private
		 */
		 ...
		 * @param node node to check
		 * @returns True if parent class implements interfaces
		 * @private
		 */
		 ...
		 * @param node node to check
		 * @returns True if it is an instance method, and not excluded by config
		 * @private
		 */
		 ...
		 * @param node A function node that was entered.
		 * @private
		 */
