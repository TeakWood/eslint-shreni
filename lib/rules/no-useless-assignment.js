 ...
 * @param pattern The pattern node to extract identifier
 ...
 * @param assignment The assignment info.
 * @param identifier The identifier to check.
 * @returns `true` if the given identifier node is evaluated after the assignment identifier.
 */
 ...
 * @param assignment The assignment info.
 * @param identifier The identifier to check.
 * @returns `true` if the given identifier node is used between the assigned identifier and the equal sign.
 */
...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns The scope of code path start
		 ...
		 * @param target The scope stack to verify.
		 */
		function verify(target) {
			/**
			 * Checks whether the given identifier is used in the segment.
			 * @param segment The code path segment.
			 * @param identifier The identifier to check.
			 * @returns `true` if the identifier is used in the segment.
			 */
			 ...
			 * @param targetAssignment The assignment info to verify.
			 * @param allAssignments The list of all assignment info for variables.
			 */
			function verifyAssignmentIsUsed(targetAssignment, allAssignments) {
				 ...
				 * @returns the subsequent segments
				 */
