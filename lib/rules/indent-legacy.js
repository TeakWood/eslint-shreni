...
module.exports = {
	...
	create(context) {
		 ...
		 * @param [byLastLine=false] get indent of node's last line
		 * @returns The node's indent. Contains keys `space` and `tab`, representing the indent of each character. Also
		 ...
		 * @param [byEndLocation=false] Lookup based on start position or end
