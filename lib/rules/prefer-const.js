 ...
 * @returns `true` if the node is located at `ForStatement.init`.
 */
 ...
 * @param identifier An Identifier node to check.
 * @returns `true` if the node can become a VariableDeclaration.
 */
 ...
 * @returns A VariableDeclarator/AssignmentExpression node or
 *      null.
 */
 ...
 * @param node The ObjectPattern or ArrayPattern node to check.
 * @returns True if the destructuring pattern contains
 ...
 * @param variable A variable to get.
 * @param ignoreReadBeforeAssign
 ...
 * @param type The type field of the parent node.
 * @param shouldStop A predicate that returns true if the traversal should stop, and false otherwise.
 * @returns The closest ancestor with the specified type; null if no such ancestor exists.
 */
