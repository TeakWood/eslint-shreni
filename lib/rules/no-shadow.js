...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns Whether the scope is a global augmentation
		 */
		 ...
		 * @returns Whether the variable is a this parameter
		 */
		 ...
		 * @param variable The variable to check
		 * @param shadowedVariable The shadowed variable
		 * @returns Whether it's a type/value shadow case to ignore
		 */
		 ...
		 * @param variable The variable to check
		 * @returns Whether it's a function type parameter shadow case to ignore
		 */
		 ...
		 * @param variable The variable to check
		 * @returns Whether the variable is a generic of a static method
		 */
		 ...
		 * @param variable The variable to check
		 * @returns Whether it's a static method generic shadowing class generic
		 */
		 ...
		 * @param expression The expression node to unwrap.
		 * @returns The uppermost ancestor that can evaluate to the given node
		 ...
		 * @param innerVariable The inner variable to check.
		 * @param outerVariable The outer variable.
		 * @returns Whether or not inner variable is the name of a
		 ...
		 * definition file.
		 * @param variable The variable to check
		 * @returns Whether the variable is declared in a definition file
		 */
		 ...
		 * @param variable The variable to check
		 * @returns Whether it's a duplicate enum name variable
		 */
		 ...
		 * @param shadowedVariable Shadowed variable
		 * @returns Whether it's an external declaration merging
		 */
		 ...
		 * @param scope The scope to check for shadowed variables.
		 */
