 ...
 * @param options A value to parse.
 ...
 * @param node `ClassBody` node to check static initializers.
 * @param location A location to check.
 * @returns `true` if the location is inside of a class static initializer.
 */
 ...
 * @returns `true` if the scope is a class static initializer scope.
 */
 ...
 * @returns `true` if the reference is from a separate execution context.
 */
 ...
 *     class C { [C]; }
 * @param reference A reference to check.
 * @returns `true` if the reference is evaluated during the initialization.
 */
 ...
 * @returns true if reference contains type query.
 */
 ...
 * @returns `true` if the reference is in a class decorator.
 */
...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns `true` if the reference should be checked
		 */
