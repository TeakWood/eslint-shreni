...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns The token to compare line to the next statement.
		 */
		 ...
		 * @returns True if `keyword` is a type of var
		 */
		 ...
		 * @private
		 * @param nodeType nodeType to test
		 * @returns True if `nodeType` is an export specifier
		 */
		 ...
		 * @returns True if `node` is last of their parent block.
		 */
		 ...
		 * @param commentStartLine The starting line of the group
		 * @returns The number of the last comment line of the group
		 */
		 ...
		 * @param commentStartLine The line number on which the comment starts
		 * @returns True if `token` does not start immediately after a comment
		 */
