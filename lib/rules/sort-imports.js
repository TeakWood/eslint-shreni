...
module.exports = {
	...
	create(context) {
		 ...
		 * @param left node that appears before the given `right` node.
		 * @param right node that appears after the given `left` node.
		 * @returns number of lines between nodes.
		 */
