...
module.exports = {
	...
	create(context) {
		 ...
		 * @param builtin The name of the native builtin being extended.
		 */
		 ...
		 * @param identifierNode The Identifier representing the object
		 * to check.
		 * @returns True if the identifier is the object of a
		 ...
		 * @returns True if an assignment to the property of the node.
		 */
		 ...
		 * @param node The node to check.
		 * @returns True if the node is at the first argument of the method call of `Object.defineProperty()` or `Object.defineProperties()`.
		 */
