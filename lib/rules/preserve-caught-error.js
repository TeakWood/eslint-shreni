 ...
 * @param throwStatement `ThrowStatement` to be checked.
 * @param optionsIndex The index of the options argument in the error constructor.
 ...
 * @returns The closest parent `CatchClause` node, `null` if the `node` is not in a catch block.
 */
...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns `true` if the callee is a built-in global Error constructor.
		 */
		 ...
		 * @param throwStatement The `ThrowStatement` that needs to be checked.
		 * @returns `true` if a new "Error" is being thrown, else `false`.
		 */
		 ...
		 * @param optionsNode The options object node.
		 * @param caughtErrorName The name of the caught error (e.g., "err").
		 ...
		 * @param firstToken The first token to start searching from.
		 * @param lastToken The last token to scan up to (inclusive).
		 * @returns The first token that isn't followed by a closing parenthesis, or `lastToken` if none is found.
		 */
		 ...
		 * @param throwExpression The thrown CallExpression or NewExpression node.
		 * @param text The arguments to insert.
		 * @returns The fixer operation.
		 */
		 ...
		 * @param fixer The fixer instance.
		 * @param throwExpression The thrown CallExpression or NewExpression node.
		 * @param text The additional arguments to insert, including the leading comma.
		 * @returns The fixer operation.
		 */
							...
							suggest: [
								{
									...
									fix(fixer) {
										 ...
										 * @param optionsArg The options argument node.
										 * @returns The fix, or `null` if the argument is not an object.
										 */
