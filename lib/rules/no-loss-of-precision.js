...
class ScientificNotation {
	/** @type The digits of the coefficient. A decimal point is implied after the first digit. */
	coefficient;

	/** @type The order of magnitude. */
	magnitude;
 ...
 * @returns the object containing the float's coefficient and order of magnitude
 */
 ...
 * @param parseAsFloat if true, the coefficient will be always parsed as a float, regardless of whether a decimal point is present
 * @returns the object containing the number's coefficient and order of magnitude
 */
