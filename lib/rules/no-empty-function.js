 ...
 * @param node A function node to get. This is one of
 *      an ArrowFunctionExpression, a FunctionDeclaration, or a
 *      FunctionExpression.
 * @returns The kind of the function. This is one of "functions",
 ...
 * @param node The function node to examine.
 * @returns True if the constructor has parameter properties, false otherwise.
 */
...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns True if the function is allowed to be empty, false otherwise.
		 */
		 ...
		 * @param node A function node to report. This is one of
		 *      an ArrowFunctionExpression, a FunctionDeclaration, or a
		 *      FunctionExpression.
		 */
