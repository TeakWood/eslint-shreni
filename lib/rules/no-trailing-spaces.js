...
module.exports = {
	...
	create(context) {
		 ...
		 * @param {Range} fixRange Range based on the whole program
		 * @returns {void}
		 */
		 ...
		 * @param {Array<Comment>} comments An array of comment nodes.
		 * @returns {Set<number>} The line numbers containing comments.
		 */
		...
		return {
			/**
			 * Reports every line of the program that ends in whitespace.
