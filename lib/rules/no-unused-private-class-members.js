...
module.exports = {
	...
	create(context) {
		 ...
		 * @param nodeOrToken The token or node to check
		 ...
		 * @param nodeOrToken The token or node to check
		 * @returns Whether the token or node starts on its own line
		 */
		 ...
		 * @param classMemberNode The class member node
		 * @returns Leading comments to remove with the member
		 */
		 ...
		 * @param classMemberNode The class member node
		 * @returns Whether the member shares its line with another token
		 */
		 ...
		 * @param classMemberNode The class member node
		 * @returns Trailing comments to remove with the member
		 */
		 ...
		 * @param classMemberNode The member that would be removed
		 * @returns The token after which a semicolon should be inserted, or null if no semicolon is needed
		 */
		 ...
		 * @param classMemberNode The member that would be removed
		 * @returns The text range to remove
		 */
