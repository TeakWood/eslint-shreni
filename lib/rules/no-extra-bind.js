...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns True if the node is known to be side-effect free, false otherwise.
		 */
		 ...
		 * @param node A node to report. This is a FunctionExpression or
		 ...
		 * @param node A node to report. This is a FunctionExpression or
		 *      an ArrowFunctionExpression.
		 * @returns `true` if the node is the callee of `.bind()` method.
		 */
		 ...
		 * @param node A node to add. This node is a FunctionExpression
		 ...
		 * @param node A node to remove. This node is a
		 ...
		 * method.
		 * @param node A node to report. This node is an
