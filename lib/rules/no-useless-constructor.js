 ...
 * @param node A method definition node.
 * @returns `true` if any parameter had a decorator or is a parameter property.
 */
 ...
 * @param node A method definition node.
 * @returns `true` if the node has a useful accessibility.
 */
