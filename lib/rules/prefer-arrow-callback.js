 ...
 * @param node A MetaProperty node to check.
 * @param metaName The name of `MetaProperty.meta`.
 * @param propertyName The name of `MetaProperty.property`.
 * @returns `true` if the node is the specific value.
 */
 ...
 * @param paramsList The list of parameters for a function
 * @returns `true` if the list of parameters contains any duplicates
 */
...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns The information of the last scope.
		 */
		function exitScope() {
			return stack.pop();
		}
