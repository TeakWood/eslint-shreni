 ...
 * @param importNames The import names to format.
 * @returns The formatted import names.
 */
 ...
 * @param importNames The import names to check.
 * @returns "is" if one import name, otherwise "are".
 */
...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns Whether the node is a type-only import
		 */
		 ...
		 * @returns Whether the specifier is type-only
		 */
		 ...
		 * @param node The node to check
		 * @returns Whether the node is a type-only export
		 */
		 ...
		 * @param importNames Map of import names that are being imported
		 * @param importSource the import source string
		 * @private
		 */
