 ...
 * @returns True if import/export type belongs to (ImportSpecifier|ExportSpecifier) or (ImportNamespaceSpecifier|ExportNamespaceSpecifier) and false if it doesn't.
 */
 ...
 * @param allowSeparateTypeImports Whether to allow separate type and value imports.
 ...
 * @param node A node to get.
 * @param modules A Map object contains as a key a module name and as value an array contains objects, each object contains a node and a declaration type.
