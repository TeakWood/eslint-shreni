 ...
 * @param node The node that the rule warns on
 * @returns - Returns true if the Object.assign call has array spread
 */
 ...
 * @returns `true` if the node is a getter or a setter.
 */
 ...
 * @returns `true` if the node has at least one getter/setter.
 */
 ...
 * @returns `true` if the node has at least one argument that is an object expression with at least one getter/setter.
 */
 ...
 * @param node The node that the rule warns on
 * @param sourceCode in context sourcecode object
 * @returns - Returns true if the node needs parentheses
 */
 ...
 * @param sourceCode in context sourcecode object
 * @returns True if the node needs parentheses
 */
 ...
 * @param leftArgumentListParen The opening paren token of the argument list.
 * @param sourceCode The source code object to get tokens.
 * @returns The parenthesis tokens of the node. This is sorted by the location.
 */
 ...
 * @param token The token to get range.
 * @param sourceCode The source code object to get tokens.
 * @returns The end of the range of the token and around whitespaces.
 */
 ...
 * @param token The token to get range.
 * @param sourceCode The source code object to get tokens.
 * @returns The start of the range of the token and around whitespaces.
 */
 ...
 * @param node The node that the rule warns on, i.e. the Object.assign call
 * @param sourceCode sourceCode of the Object.assign call
 * @returns autofixer - replaces the Object.assign with a spread object.
 */
