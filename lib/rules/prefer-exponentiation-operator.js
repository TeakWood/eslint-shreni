 ...
 * @param base The node to check.
 * @returns `true` if the node needs to be parenthesised.
 */
 ...
 * @param exponent The node to check.
 * @returns `true` if the node needs to be parenthesised.
 */
 ...
 * @param node A node that would be replaced by an exponentiation binary expression.
 * @param sourceCode A SourceCode object.
 * @returns `true` if the expression needs to be parenthesised.
 */
 ...
 * @param text The text to parenthesize.
 * @param shouldParenthesize If `true`, the text will be parenthesised.
 * @returns parenthesised or unchanged text.
 */
...
module.exports = {
	...
	create(context) {
		 ...
		 * @param node 'Math.pow()' node to report.
		 */
