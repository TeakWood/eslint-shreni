 ...
 * @returns Whether or not it is a comparison operator.
 */
 ...
 * @param operator The operator to check.
 * @returns Whether or not it is an equality operator.
 */
 ...
 * @param operator The operator to check.
 * @returns Whether the operator is used in range tests.
 */
 ...
 * @returns True if the node is a negative number that looks like a
 ...
 * @param node Node to test
 * @returns True if the node should be treated as a single Literal node.
 */
...
module.exports = {
	...
	create(context) {
		 ...
		 * @param node LogicalExpression node to test.
		 * @returns Whether node is a range test.
		 */
		function isRangeTest(node) {
			 ...
			 * @returns Whether node is a "between" range test.
			 */
			 ...
			 * @returns Whether node is an "outside" range test.
			 */
			 ...
			 * @returns Whether node is preceded immediately by an open
		 ...
		 * @param node The BinaryExpression node
		 * @returns A string representation of the node with the sides and operator flipped
		 */
