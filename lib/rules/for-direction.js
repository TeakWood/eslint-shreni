...
module.exports = {
	...
	create(context) {
		 ...
		 * @returns return dir, the negated dir, or zero if the counter does not change or the direction is not clear
		 */
		 ...
		 * @param counter The name of the counter variable.
		 * @returns An array of modifying expressions.
		 */
		 ...
		 * @param expr An expression node to check (UpdateExpression or AssignmentExpression).
		 * @param counter The variable name of the counter.
		 * @returns 1 if incrementing, -1 if decrementing, 0 if unknown or not modifying the counter.
		 */
