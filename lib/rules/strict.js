 ...
 * statements.
 * @param {Array<ASTNode>} statements Statements in the program or function body.
 * @returns {Array<ASTNode>} All of the Use Strict Directives.
 */
 ...
 * @param {Array<ASTNode>} params A parameter list to check.
...
module.exports = {
	...
	create(context) {
		 ...
		 * @param {Array<ASTNode>} nodes Nodes.
		 * @param {number} start Index to start from.
		 * @param {number} end Index to end before.
		 ...
		 * @param {Array<ASTNode>} useStrictDirectives The Use Strict Directives of the node.
		 * @returns {void}
		 */
		...
		const rule = {
			/**
			 * Checks the Use Strict Directives of the whole program.
		...
		if (mode === "function") {
			Object.assign(rule, {
				/**
				 * Records that the following code is inside a class body, which
				...
				/**
				 * Records that the code is no longer inside a class body.
				 * @returns {void}
				 */
				"ClassBody:exit"() {
					classScopes.pop();
