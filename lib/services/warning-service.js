...
/**
 * Emits a warning using whatever API the host runtime provides. The signature
 * mirrors the subset of `process.emitWarning()` that this service uses: a
 * message and a warning type.
 * @typedef {(warning: string, type: string) => void} EmitWarning
 */
...
class WarningService {
	 ...
	 * @param {EmitWarning} [options.emitWarning] A function called internally to
	 *      emit warnings using API provided by the runtime.
	 */
	constructor({
