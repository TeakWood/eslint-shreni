...
class SuppressionsService {
	 ...
	 * @param [options.filePath] The location of the suppressions file.
	 ...
	 * @param rules The rules to suppress.
	 */
	 ...
	 * @returns The updated results and the unused suppressions.
	 */
	 ...
	 * @throws If the suppressions file cannot be parsed.
	 ...
	 * @param suppressions The suppressions to save.
	 * @private
	 */
	save(suppressions) {
	 ...
	 * @returns The number of violations by rule.
	 */
