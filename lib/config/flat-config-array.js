 ...
 * @param originalLength The original length of the config array.
 * @param baseLength The length of the base config.
 * @returns The new error with details.
 */
...
class FlatConfigArray extends ConfigArray {
	 ...
	 * @param [context] The context to use to normalize the array.
	 * @returns A promise that resolves when the array is normalized.
	 */
	normalize(context) {
	 ...
	 * normalization.
	 * @param config The config to preprocess.
	 * @returns The preprocessed config.
	 */
	 ...
	 * @param config The config to finalize.
	 * @returns The finalized config.
	 * @throws If the config is invalid.
	 */
