 ...
 * @property {Array<Object>} [baseConfig] The config objects to place before the
 *      ones read from the config file.
 * @property {boolean} [ignoreEnabled] Determines if `ignores` fields outside of
 *      `baseConfig` should be honored.
 * @property {Array<string>} [ignorePatterns] Additional ignore patterns, which
 *      are appended after everything else so they win.
 * @property {Object|Array<Object>} [overrideConfig] The config objects to append
