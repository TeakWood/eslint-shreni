 ...
 * @param ast The Program node of the AST to check.
 * @throws If the AST doesn't contain the correct information.
 * @private
 */
 ...
 * @param ecmaVersion The version to retrieve globals for.
 * @returns The globals for the given ecmaVersion.
 */
 ...
 * @returns A sorted list of tokens and comments.
 * @private
 */
 ...
 * @returns The value normalized as a string
 * @throws if global value is invalid
 */
 ...
 * @param lineStartIndices Sorted array of line start indices.
 * @param target The character index to find the line number for.
 * @returns The 1-based line number for the target index.
 * @private
 */
 ...
 * @param configGlobals The globals declared in configuration
 * @param inlineGlobals The globals declared in the source code
 */
 ...
 * @param globalScope The global scope to define exports in.
 * @param variables An object whose keys are the variable
 *      names to export.
 */
...
class SourceCode extends TokenStore {
	 ...
	 * @param textOrConfig The source code text or config object.
	 * @param textOrConfig.text The source code text.
	 * @param textOrConfig.ast The Program node of the AST representing the code. This AST should be created from the text that BOM was stripped.
	 * @param textOrConfig.hasBOM Indicates if the text has a Unicode BOM.
	 * @param textOrConfig.parserServices The parser services.
	 * @param textOrConfig.scopeManager The scope of this source code.
	 * @param textOrConfig.visitorKeys The visitor keys to traverse AST.
	 * @param [astIfNoConfig] The Program node of the AST representing the code. This AST should be created from the text that BOM was stripped.
	 */
	 ...
	 * @throws If non-numeric index or index out of range.
	 * @returns A {line, column} location object with 1-indexed line and 0-indexed column.
	 * @public
	 */
	 ...
	 * @param loc.column The column number of the location (0-indexed)
	 * @throws If `loc` is not an object with a numeric
	 ...
	 * @throws If the `currentNode` argument is missing.
	 */
	 ...
	 * @returns An array of variable nodes representing
	 ...
	 * @param node The node
	 * @returns All the ancestor nodes in the AST, not including the provided node, starting
	 * from the root node at index 0 and going inwards to the parent node.
	 * @throws When `node` is missing.
	 */
	getAncestors(node) {
		if (!node) {
			throw new TypeError("Missing required argument: node.");
	 ...
	 * @param languageOptions The language options for this run.
	 */
