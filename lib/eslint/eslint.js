 ...
 * @param rules a map of rules from which to generate the object.
 * @returns metadata for all enabled rules.
 */
 ...
 * @returns Replacement rule names.
 */
 ...
 * @param maybeFilePath The absolute path to a lint target file or `"<text>"`.
 * @returns The used deprecated rule list.
 */
 ...
 * @param eslint The ESLint instance.
 * @param results The linting results to process.
 * @returns The processed linting results.
 */
 ...
 * @param a The first lint result.
 * @param b The second lint result.
 * @returns An integer representing the order in which the two results should occur.
 */
 ...
 * @param options Config file location options.
 ...
 * @param cause The original error that led to this symptom error being thrown. Might not always be available.
 ...
 * @param processableFileCount The number of files that need to be processed.
 * @param maxWorkers The maximum number of workers to run.
 ...
 * @param lintResultCache The lint result cache.
 * @param fix The fix option.
 * @param filePath The file for which to retrieve lint results.
 * @param config The config of the file.
 * @returns True if the file needs to be reprocessed.
 */
 ...
 * @param filePaths File paths to lint.
 * @param maxWorkers The maximum number of workers to run.
 * @returns The number of worker threads to run for "auto" concurrency.
 */
 ...
 * @param eslint The ESLint instance.
 * @param filePaths File paths to lint.
 * @param [os] Node.js `os` module, or a mock for testing.
 * @returns The effective number of worker threads to be started. A value of zero disables multithread linting.
 */
 ...
 * @param filePaths File paths to lint.
 * @param workerCount The number of worker threads to run.
 * @param eslintOptionsOrURL The unprocessed ESLint options or the URL of the options module.
 * @param warnOnLowNetLintingRatio A function to call if the net linting ratio is low.
...
async function runWorkers(
	 ...
	 * @param resolve_ Called when the worker thread terminates successfully.
	 * @param reject Called when the worker thread terminates with an error.
	 */
	function workerExecutor(resolve_, reject) {
		const workerStartTime = hrtimeBigint();
		const worker = new Worker(workerURL, workerOptions);
		worker.once("message", indexedResults => {
 ...
 * @throws If the options are not cloneable.
 */
...
class ESLint {
	 ...
	 * @param optionsURL The URL of the options module.
	 * @returns The new ESLint instance.
	 */
	 ...
	 * @throws When the results object wasn't created from this ESLint instance.
	 * @throws When a plugin or rule is missing.
	 */
	...
	async loadFormatter(name = "stylish") {
		...
		return {
			 ...
			 * @returns The formatted lint results.
			 */
	 ...
	 * @param [filePath] The path of the file to find the config file for.
