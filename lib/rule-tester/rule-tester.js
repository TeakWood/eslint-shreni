 ...
 * @param seenObjects Objects already seen during the traversal.
 */
 ...
 * @param objName Object name used for error messages.
 * @param node The node to define.
 */
 ...
 * @param ast The root node to errorize `start`/`end` properties.
 * @param [visitorKeys] Visitor keys to be used for traversing the given ast.
 */
 ...
 * @param item The test case item to normalize.
 * @returns The normalized test case object.
 */
 ...
 * @param errors The `errors` property of the invalid test case.
 * @param ruleName The name of the rule being tested.
 * @param [assertionOptions] The assertion options for the test case.
 */
 ...
 * @param test The test scenario object to check.
 * @param ruleName The name of the rule being tested.
 * @throws If the test scenario object is not valid.
 */
 ...
 * @param item The test case object to check.
 */
 ...
 * @param item The valid test case object to check.
 * @param seenTestCases Set of serialized test cases to check for duplicates.
 * @throws If the test case is not valid.
 */
 ...
 * Optional properties are checked for correct types.
 * @param item The invalid test case object to check.
 * @param seenTestCases Set of serialized test cases to check for duplicates.
 * @param ruleName The name of the rule being tested.
 * @param [assertionOptions] The assertion options for the test case.
 * @throws If the test case is not valid.
 ...
 * @param relative The function before the invocation point.
 * @returns The invocation location.
 */
 ...
 * @param invoker The method that runs the tests.
 * @returns The lazy resolver for the estimated location of the test case.
 */
 ...
 * @param method The logic of the test case.
 * @throws Any error upon execution of `method`.
...
class RuleTester {
	 ...
	 * @param [testerConfig] Optional, extra configuration for the tester
	 */
	...
	run(ruleName, rule, test) {
		 ...
		 * @param item Item to run the hook on
		 * @param prop The property having the hook assigned to
		 * @throws If the property is not a function or that function throws an error
		 * @private
		 */
		 ...
		 * @param item Item to run the rule against
		 * @private
		 * @throws If the test case is invalid or has an invalid error.
		 */
